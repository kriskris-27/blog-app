  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>TechLife Startup Blog is your go-to platform for the latest in technology, startups, and lifestyle. Stay ahead with expert insights on AI, web development, and entrepreneurship, while also discovering productivity hacks and wellness tips. Whether you are a tech enthusiast, a founder, or a lifelong learner, we bring you curated content to inspire and empower your journey. 🚀✨</p>
